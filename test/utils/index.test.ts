...
describe("utils", () => {
  ...
  describe("records period helpers", () => {
    ...
    it("evalua correctamente si una fecha cae en dia, semana o mes", () => {
      ...
      expect(
        isDateInPeriod(new Date("2026-03-15T12:00:00.000Z"), "custom_cycle", referenceDate, 10)
      ).toBe(true);
      expect(
        isDateInPeriod(new Date("2026-03-10T12:00:00.000Z"), "custom_cycle", referenceDate, 10)
      ).toBe(true);
      expect(
        isDateInPeriod(new Date("2026-03-09T12:00:00.000Z"), "custom_cycle", referenceDate, 10)
      ).toBe(false);
      expect(
        isDateInPeriod(new Date("2026-04-09T12:00:00.000Z"), "custom_cycle", referenceDate, 10)
      ).toBe(true);
      expect(
        isDateInPeriod(new Date("2026-04-10T12:00:00.000Z"), "custom_cycle", referenceDate, 10)
      ).toBe(false);
      ...
      expect(
        isDateInPeriod(new Date("2026-02-15T12:00:00.000Z"), "custom_cycle", earlyReferenceDate, 10)
      ).toBe(true);
      expect(
        isDateInPeriod(new Date("2026-03-08T12:00:00.000Z"), "custom_cycle", earlyReferenceDate, 10)
      ).toBe(true);
      expect(
        isDateInPeriod(new Date("2026-03-10T12:00:00.000Z"), "custom_cycle", earlyReferenceDate, 10)
      ).toBe(false);
    });
