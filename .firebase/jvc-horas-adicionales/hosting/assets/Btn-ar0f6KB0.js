import { c as S, r as c, j as _ } from "./index-BK3p98bF.js";
const k = (u) => {
  const t = S.c(9),
    { children: a, label: h, onClick: n, variant: x, formState: l, type: p, title: g, size: y } = u,
    m = x === void 0 ? "primary" : x,
    d = p === void 0 ? "button" : p,
    i = g === void 0 ? "" : g,
    f = y === void 0 ? "md" : y;
  let e;
  ...
  t[1] === Symbol.for("react.memo_cache_sentinel")
    ? ((o = {
      ...
      (t[1] = o))
    : (o = t[1]);
  const [w] = c.useState(o),
    s = `${v[m]} ${w[f]} transition-colors duration-300`,
    b = a || h;
  let r;
  return (
    t[2] !== l || t[3] !== n || t[4] !== s || t[5] !== b || t[6] !== i || t[7] !== d
      ? ((r = _.jsx("button", {
          type: d,
          className: s,
          onClick: n,
