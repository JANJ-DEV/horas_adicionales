  ...
  return (<section>
    <formAction.Form className="flex flex-col gap-4" method="post">
      <div className="flex flex-col text-xl border p-4 rounded-xl gap-4">
        ...
        <input id="nombre-empresa" title="Nombre de la empresa" type="text" name="nombre-empresa" placeholder="" required />
      </div>
      <div className="flex flex-col text-xl border p-4 rounded-xl gap-4">
      ...
      <div className="flex flex-col text-xl border p-4 rounded-xl gap-4">
        ...
        <input id="hora-entrada" title="Hora de entrada" type="time" name="hora-entrada" placeholder="" required />
      </div>
      <div className="flex flex-col text-xl border p-4 rounded-xl gap-4">
        <label htmlFor="hora-salida">Hora de salida</label>
        <input id="hora-salida" title="Hora de salida" type="time" name="hora-salida" placeholder="" required />
      </div>
